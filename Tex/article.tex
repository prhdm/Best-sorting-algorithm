...
see the plots of the growth of different algorithms with same giving input from next page:
 ...
 \begin{figure}[htbp]
\centerline{\includegraphics[scale=1]{../../../../SMALLNUMMS.png} }
...
\end{figure}
 ...
 \begin{figure}[htbp]
\centerline{ \includegraphics[scale=1]{../../../../SORTEDNUMS.png} }
\caption{\textbf{SORTED NUMBERS}}
\label{fig}
\end{figure}

 \begin{figure}[htbp]
\centerline{ \includegraphics[scale=1]{../../../../NEGATIVE NUMS.png} }
...
\end{figure}
 ...
 \begin{figure}[htbp]
\centerline{\includegraphics[scale=1]{../../../../REVESREDNUMS.png} }
...
\end{figure}
 ...
 \begin{figure}[htbp]
\centerline{ \includegraphics[scale=1]{../../../../DUPLICATENUMS.png} }
